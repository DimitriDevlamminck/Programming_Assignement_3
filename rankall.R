# rankall is a funtion that will output a 2-column data frame given 2 selection arguments:
# 'outcome' which can be: 'heart attack', 'heart failure', 'pneumonia'
# 'num' which can be: 
#    - 'best' : for the best hospital in the selection
